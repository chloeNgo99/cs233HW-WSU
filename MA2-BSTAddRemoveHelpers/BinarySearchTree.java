		...
		if (item.compareTo(root.getValue()) == 0)
		{
			...
			if (_remove_counter % 2 == 0)
			{
				...
				if(current.getLeftChild() != null ) {
					current.setValue(findLargest(current.getLeftChild()).getValue());
					current.setLeftChild(removeLargest(root.getLeftChild()));
				}else if(current.getRightChild() != null) {
					current.setValue(root.getRightChild().getValue());
					removeSmallest(root.getRightChild());
				}else {
					root = null;
				}
			...
			else
			{
				...
				if(current.getRightChild() != null ) {
					current.setValue(findSmallest(current.getRightChild()).getValue());
					current.setRightChild(removeSmallest(root.getRightChild()));
				}else if(current.getLeftChild() != null) {
					current.setValue(root.getLeftChild().getValue());
					removeSmallest(root.getLeftChild());
				}else {
					root = null;
				}
			}
